...
namespace Library.API.Controllers
{
    ...
    public class AuthorsController : Controller
    {
            ...
            [FromHeader(Name = "Accept")] string mediaType)
        {
            ...
            {
                var previousPageLink = authorsFromRepo.HasPrevious ? CreateAuthorsResourceUri
                    (authorsResourceParameters, ResourceUriType.PreviousPage) : null;

                var nextPageLink = authorsFromRepo.HasNext ? CreateAuthorsResourceUri
                    (authorsResourceParameters, ResourceUriType.NextPage) : null;
